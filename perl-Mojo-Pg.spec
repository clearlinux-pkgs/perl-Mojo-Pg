...
Source0  : https://cpan.metacpan.org/authors/id/S/SR/SRI/Mojo-Pg-4.26.tar.gz
...
%prep
%setup -q -n Mojo-Pg-4.26
cd %{_builddir}/Mojo-Pg-4.26
...
cp %{_builddir}/Mojo-Pg-4.26/LICENSE %{buildroot}/usr/share/package-licenses/perl-Mojo-Pg/2f8018a02043ed1a43f032379e036bb6b88265f2
if test -f Makefile.PL; then
