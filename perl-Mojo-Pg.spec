...
%prep
%setup -q -n Mojo-Pg-4.19
cd %{_builddir}/Mojo-Pg-4.19
...
cp %{_builddir}/Mojo-Pg-4.19/LICENSE %{buildroot}/usr/share/package-licenses/perl-Mojo-Pg/2f8018a02043ed1a43f032379e036bb6b88265f2
if test -f Makefile.PL; then
